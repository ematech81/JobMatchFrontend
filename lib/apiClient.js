...
export const generateApplication = (jobId, addedSkills = []) =>
  request(`/jobs/${encodeURIComponent(jobId)}/application`, { method: 'POST', body: { addedSkills } });
export const getGeneratedApplication = (jobId) =>
  request(`/jobs/${encodeURIComponent(jobId)}/application`);
export const updateGeneratedApplication = (jobId, fields) =>
  request(`/jobs/${encodeURIComponent(jobId)}/application`, { method: 'PUT', body: fields });
export const downloadApplicationResumePdf = (jobId) =>
  request(`/jobs/${encodeURIComponent(jobId)}/application/resume.pdf`, { raw: true });
export const downloadApplicationCoverLetterPdf = (jobId) =>
  request(`/jobs/${encodeURIComponent(jobId)}/application/cover-letter.pdf`, { raw: true });
