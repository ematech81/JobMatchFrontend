...
export function AuthProvider({ children }) {
  ...
  // Shared by every way of ending up with a token+user pair (password login,
  // register, Google) — same session bookkeeping regardless of how it was
  // obtained.
  ...
  // idToken comes from Google Identity Services on the client — the backend
  // verifies it against Google's public keys before ever trusting it (see
  // authController.googleAuth), same as every other credential this app
  // accepts.
